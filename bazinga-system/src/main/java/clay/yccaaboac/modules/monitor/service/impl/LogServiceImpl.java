...
import clay.yccaaboac.modules.monitor.repository.LogRepository;
...
public class LogServiceImpl implements LogService {
    ...
    public void save(String username, String browser, String ip, ProceedingJoinPoint joinPoint, Log log) {
        ...
        clay.yccaaboac.modules.monitor.annotation.Log aopLog = method.getAnnotation(clay.yccaaboac.modules.monitor.annotation.Log.class);
